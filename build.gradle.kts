...
configure(subprojects) {
    ...
    configure<DependencyManagementExtension> {
        ...
        dependencies {
            ...
            dependency("org.apache.tika:tika-core:1.21")
            ...
            dependency("org.jboss.resteasy:resteasy-client:4.1.1.Final")
            dependency("org.jooq:joor-java-8:0.9.12")
